...
RcppExport SEXP _stabest2_stabest2_internal(SEXP VcSEXP, SEXP VsSEXP, SEXP Vs_minSEXP, SEXP XcSEXP, SEXP XcXcInvSEXP, SEXP betaRSEXP, SEXP VacantSeatsSEXP, SEXP nObs_collegeSEXP, SEXP ID_eqCollegeSEXP, SEXP matchSEXP, SEXP sidSEXP, SEXP ID_cBetterSEXP, SEXP ID_cWorseSEXP, SEXP ID_nextCollegeSEXP, SEXP niterSEXP, SEXP thinSEXP, SEXP demeanSEXP) {
  BEGIN_RCPP
  ...
  rcpp_result_gen = Rcpp::wrap(stabest2_internal(Vc, Vs, Vs_min, Xc, XcXcInv, betaR, VacantSeats, nObs_college, ID_eqCollege, match, sid, ID_cBetter, ID_cWorse, ID_nextCollege, niter, thin, demean));
  return rcpp_result_gen;
  END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
  {"_stabest2_stabest2_internal", (DL_FUNC) &_stabest2_stabest2_internal, 17},
  {NULL, NULL, 0}
};
